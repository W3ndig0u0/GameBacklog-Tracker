                ...
                >
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="space-y-0.5">
                      <div className="font-bold text-[12px] text-zinc-200 uppercase tracking-wider">
                        {item.status}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-right">
                    {item.isFavorite ? (
                      <span className="inline-flex items-center gap-1 text-amber-400 font-bold bg-amber-400/10 px-1 py-1 rounded-lg text-s">
                        <svg
                          className="w-3 h-3"
                          fill="currentColor"
                          viewBox="0 0 20 20"
