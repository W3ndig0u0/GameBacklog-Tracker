...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white font-sans pb-20 border-radius-10">
        ...
        <div className="flex flex-col items-center text-center mb-10">
          <div className="relative group cursor-pointer">
            <img
              src={avatar}
              alt={user.name}
              className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover border-4 border-[#09090b] shadow-[0_0_20px_rgba(170,59,255,0.2)] transition-transform duration-300 group-hover:scale-105 relative z-10"
            />
